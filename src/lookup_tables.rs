...
pub const SLIDERS_TABLE: ([Bitboard; 107648], [SliderTableEntry; 128]) = {
    let magics: [u64; 128] = [
        293861533946085504,
        99361787782299656,
        22525712988637184,
    ...
    while square < 128 {
        ...
        loop {
            let index = ((blockers.0 & entry.blockers_mask.0).wrapping_mul(entry.magic)
            ...
            blockers.0 = blockers.0.wrapping_sub(entry.blockers_mask.0) & entry.blockers_mask.0;
